...
\contentsline {lstlisting}{\numberline {3}Git: git add}{14}{lstlisting.3}
\contentsline {lstlisting}{\numberline {4}Git: git commit}{14}{lstlisting.4}
\contentsline {lstlisting}{\numberline {5}Git: git push}{14}{lstlisting.5}
\contentsline {lstlisting}{\numberline {6}Git: git init}{15}{lstlisting.6}
\contentsline {lstlisting}{\numberline {7}Git: git remote add}{15}{lstlisting.7}
